...
class CityListTest {
    ...
    void testHasCity() {
        ...
        assertFalse(cityList.hasCity(new City("fakeCity", "fakeProvince")));
    }
    ...
    void testDeleteCity() throws Exception {
        ...
        assertThrows(Exception.class, () -> cityList.delete(mockCity()));
    }
    ...
    void testCountCities() throws Exception{
        ...
        cityList.add(mockCity());
        cityList.add(new City("anotherCity", "anotherProvince"));
